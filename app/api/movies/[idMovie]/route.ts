...
export async function PUT(request: Request, { params }: { params: { idMovie: any } }): Promise<NextResponse> {
    try {
      const client: MongoClient = await clientPromise;
      const db: Db = client.db('sample_mflix');
      const { idMovie } = params;
...
export async function DELETE(request: Request, { params }: { params: { idMovie: any } }): Promise<NextResponse> {
    try {
      const client: MongoClient = await clientPromise;
      const db: Db = client.db('sample_mflix');
      const { idMovie } = params;
